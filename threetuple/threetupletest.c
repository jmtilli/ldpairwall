...
int main(int argc, char **argv)
{
  ...
  hash_seed_init();
  threetuplectx_init(&ctx, NULL, NULL);
  ...
  if (threetuplectx_add(&ctx, &heap, 1, 0, (10<<24) | 1, 12345, 17, 1, 1, &payload, gettime64()) != 0)
  {
    abort();
  }
  ...
  if (threetuplectx_add(&ctx, &heap, 1, 0, (10<<24) | 1, 12345, 17, 1, 1, &payload, gettime64())
      != -EEXIST)
  {
    abort();
  }
  ...
  if (threetuplectx_modify(&ctx, &heap, 1, 0, (10<<24) | 1, 12345, 17, 1, 1, &payload, gettime64()) != 0)
  {
    abort();
  }
  if (threetuplectx_modify(&ctx, &heap, 1, 0, (10<<24) | 1, 12345, 17, 1, 1, &payload, gettime64()) != 0)
