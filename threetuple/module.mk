...
CFLAGS_THREETUPLE := -I$(DIRHASHLIST) -I$(DIRMISC) -I$(DIRHASHTABLE) -I$(DIRTIMERLINKHEAP) -I$(DIRAIRWALL) -I$(DIRLINKEDLIST)
LIBS_THREETUPLE := $(DIRMISC)/libmisc.a $(DIRHASHTABLE)/libhashtable.a $(DIRLOG)/liblog.a $(DIRTIMERLINKHEAP)/libtimerlinkheap.a $(DIRAIRWALL)/libairwall.a
