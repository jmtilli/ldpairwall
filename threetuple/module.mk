...
CFLAGS_THREETUPLE := -I$(DIRHASHLIST) -I$(DIRMISC) -I$(DIRHASHTABLE) -I$(DIRTIMERLINKHEAP)
LIBS_THREETUPLE := $(DIRMISC)/libmisc.a $(DIRHASHTABLE)/libhashtable.a $(DIRLOG)/liblog.a $(DIRTIMERLINKHEAP)/libtimerlinkheap.a
