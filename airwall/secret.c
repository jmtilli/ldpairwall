  ...
  uint32_t other_isn)
{
  ...
  a46.u.u4.ip1 = ip1;
  a46.u.u4.ip2 = ip2;
  return verify_cookie46(info, airwall, &a46, port1, port2, isn, mss, wscale,
  ...
  uint32_t other_isn)
{
  ...
  a46.u.u4.ip1 = ip1;
  a46.u.u4.ip2 = ip2;
  return form_cookie46(info, airwall, &a46, port1, port2, mss, wscale,
                       sack_permitted, other_isn);
}
  ...
  uint16_t *mss, uint8_t *wscale)
{
  ...
  a46.u.u4.ip1 = ip1;
  a46.u.u4.ip2 = ip2;
  return verify_timestamp46(info, airwall, &a46, port1, port2, isn, mss, wscale);
}
  ...
  uint16_t mss, uint8_t wscale)
{
  ...
  a46.u.u4.ip1 = ip1;
  a46.u.u4.ip2 = ip2;
  return form_timestamp46(info, airwall, &a46, port1, port2, mss, wscale);
}
