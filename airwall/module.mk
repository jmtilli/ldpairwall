...
CFLAGS_AIRWALL := -I$(DIRPACKET) -I$(DIRLINKEDLIST) -I$(DIRIPHDR) -I$(DIRMISC) -I$(DIRLOG) -I$(DIRHASHTABLE) -I$(DIRHASHLIST) -I$(DIRPORTS) -I$(DIRALLOC) -I$(DIRTIMERLINKHEAP) -I$(DIRMYPCAP) -I$(DIRDYNARR) -I$(DIRIPHASH) -I$(DIRSACKHASH) -I$(DIRTHREETUPLE) -I$(DIRDATABUF) -I$(DIRNETMAP) -I$(DIRLDP) -I$(DIRARP)
...
AIRWALL: $(DIRAIRWALL)/ldpairwall $(DIRAIRWALL)/detecttest $(DIRAIRWALL)/detectperf $(DIRAIRWALL)/genchartbl $(DIRAIRWALL)/unittest
